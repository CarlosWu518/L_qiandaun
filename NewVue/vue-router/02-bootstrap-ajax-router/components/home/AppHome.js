...
(function() {
    ...
    window.AppHome = {
        ...
        created() {
            axios.get('http://127.0.0.1:5500/NewVue/vue-router/02-bootstrap-ajax-router/emp.json').then((response) => {
                //success
            ...
            axios.get('http://127.0.0.1:5500/NewVue/vue-router/02-bootstrap-ajax-router/hobbies.json').then((response) => {
                //success
                console.log(response.data);
